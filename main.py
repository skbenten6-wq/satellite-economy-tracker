...
# --- 1. AUTHENTICATION (HEADLESS ROBOT MODE) ---
try:
    # Load the JSON Key from GitHub Secrets
...
# --- 2. DEFINE THE 12-SECTOR TARGETS ---
targets = {
    # ROW 1: ENERGY
    "1. TATA STEEL (Furnaces)": { "roi": [86.1950, 22.7950, 86.2050, 22.8050], "vis": {'bands': ['B12', 'B11', 'B4'], 'min': 0, 'max': 4000}, "desc": "Orange = Heat" },
    "2. NTPC DADRI (Coal)": { "roi": [77.5500, 28.5900, 77.5700, 28.6100], "vis": {'bands': ['B4', 'B3', 'B2'], 'min': 0, 'max': 3000}, "desc": "Black = Inventory" },
    "3. BHADLA SOLAR": { "roi": [71.9000, 27.5300, 71.9400, 27.5600], "vis": {'bands': ['B4', 'B3', 'B2'], 'min': 0, 'max': 3000}, "desc": "Blue = Expansion" },
    # ROW 2: DEFENSE & OIL
    "4. GRSE DRY DOCK": { "roi": [88.2920, 22.5440, 88.2960, 22.5470], "vis": {'bands': ['B8', 'B4', 'B3'], 'min': 0, 'max': 3000}, "desc": "Grey = Work" },
    ...
    "8. CONCOR DELHI": { "roi": [77.2880, 28.5200, 77.2980, 28.5300], "vis": {'bands': ['B4', 'B3', 'B2'], 'min': 0, 'max': 3000}, "desc": "Texture = Volume" },
    ...
    "12. NAGARJUNA SAGAR": { "roi": [79.2900, 16.5700, 79.3300, 16.6000], "vis": {'bands': ['B8', 'B4', 'B3'], 'min': 0, 'max': 3000}, "desc": "Black = Water" }
}
...
# --- 4. EXECUTE & SAVE FOR EMAIL ---
print("🚀 Scanning & Generating Dashboard...")
...
plt.tight_layout()
plt.savefig("dashboard.png") # This file will be emailed
